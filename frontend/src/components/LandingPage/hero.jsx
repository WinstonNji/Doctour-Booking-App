...
const Hero = () => {
  return (
    <div className='flex flex-col bg-primary pt-12 px-6  mt-4 rounded-xl gap-12 md:flex-row  md:px-20 md:pt-16 md:h-[70vh]'>
        <div className='flex flex-col items-center justify-center gap-4'>
            ...
            <div className='flex flex-col gap-3 md:flex-row md:self-start text-white '>
                <img className='w-32 self-center' src={assets.group_profiles} alt="" />
                <p className='text-sm md:whitespace-pre-wrap'>Simply brows through our extensive list of trusted doctors, schedule your appointment hassle-free</p>
            </div>  
        ...
        <div className='flex self-center'>
            <img className='w-92 self-center md:-mb-[50px]  md:w-3xl' src={assets.header_img} alt="" />
        </div>
